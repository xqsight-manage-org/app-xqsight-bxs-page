...
(function(){
    xqsight.wechat.myPromise = function(){
        ...
        this.init = function() {
            ...
            $("#promiseInfo").delegate("li","click",function(){
        ...
        this.cancenPromiseInfo = function(){
            $("#promiseInfo").delegate(".swipeout-actions-right>a","click",function(event){
                ...
                var changeObj = $(this).parent().find(".item-inner>.item-after");
...
var myPromise = new xqsight.wechat.myPromise();